            ...
            <div className="mini_cart_wrap">
                <div className="search_header mini_search_frm pr js_frm_search" role="search">
                    ...
                    <div className="frm_search_input pr oh">
                        <input className="search_header__input js_iput_search placeholder-black" autoComplete="off"
                            type="text" name="q" placeholder="Search for products"/>
                        <button className="search_header__submit js_btn_search" type="submit">
                            <i className="iccl iccl-search"></i></button>
                    </div>
                    <div className="ld_bar_search"></div>
                </div>
                <div className="search_header__prs fwsb cd">
                    <span className="h_suggest">Need some inspiration?</span><span className="h_result dn">Search
                        Result:</span><span className="h_results dn">Search Results:</span>
                </div>
                <div className="search_header__content mini_cart_content fixcl-scroll widget">
                    <div className="fixcl-scroll-content product_list_widget">
                        <div className="js_prs_search">
                            <div className="row mb__10 pb__10">
                                <div className="col widget_img_pr">
                                    <a className="db pr oh" href="#"><img
                                            ...
                                            className="w__100 lz_op_ef lazyload" alt="sunlight bell solar lamp"
                                            data-src="mypage/assets/images/catdog.jpg" width="80"
                                            height="80"/></a>
                                </div>
                                <div className="col widget_if_pr">
                                    <a className="product-title db" href="#">sunlight bell solar
                                        lamp</a>$35.00
                                </div>
                            </div>
                            ...
                            <a href="#" className="btn fwsb detail_link">View All
                                <i className="las la-arrow-right fs__18"></i></a>
                        </div>
                    </div>
                </div>
            </div>
