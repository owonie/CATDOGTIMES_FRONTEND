...
const Mypage_updatemyinfo = ({user,sessionInfo}) => {
        ...
        <div className="row pb-5">
          <div className="col-3">
              <div className="profile-img">
                <img alt="프로필 사진 바꾸기" id="photo" src={`mypage/assets/images/photo.jpg`}/>
              </div>
          </div>

          <div className="col-9">
            <form encType="multipart/form-data" method="POST" role="presentation">
              <h1 className="nick_name">kkokjin</h1>
        ...
        <form className="myinfo" method="POST">
          <div className="row pb-3">
            ...
            <div className="col-sm-6">
                <input id="name" placeholder="이름" type="text" className="input-text" value=""/>
          ...
          <div className="row pb-3">
            ...
            <div className="col-sm-6">
                <input id="addr" placeholder="주소" type="text" className="input-text" value=""/>
                <div className="hint small"></div>
            </div>
            <div className="col-sm-3">
...
export default Mypage_updatemyinfo;
